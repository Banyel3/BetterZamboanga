...
function updateDisplay(quarter) {
  ...
  animateValue(
    document.getElementById("sre-net-income"),
  ...
  document.getElementById("sre-income-local").textContent = formatPeso(
    data.income.local
  );
  ...
  document.getElementById("sre-income-external").textContent = formatPeso(
  ...
  document.getElementById("sre-exp-gps").textContent = formatPeso(
  ...
  document.getElementById("sre-exp-social").textContent = formatPeso(
  ...
  document.getElementById("sre-exp-economic").textContent = formatPeso(
