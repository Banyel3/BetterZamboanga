...
export const metadata: Metadata = {
  ...
  description: 'Social welfare programs and assistance services in Zamboanga City.',
};

const services = (servicesData.services as Service[]).filter(
  (s) => s.categoryId === 'social-services'
);
      ...
      <section className="page-header-v3 py-12">
        <div className="container mx-auto px-4 relative z-10">
          <nav className="text-sm text-gray-300 mb-4">
            ...
            <span className="mx-2">/</span>
            <span className="text-white">Social Services</span>
          </nav>
          ...
          <p className="text-gray-200 max-w-2xl">
            Social welfare programs, senior citizen benefits, PWD services, and financial assistance.
          </p>
        </div>
      </section>
