...
export const metadata: Metadata = {
  ...
  description: 'Scholarship programs and educational assistance in Zamboanga City.',
};

const services = (servicesData.services as Service[]).filter(
  (s) => s.categoryId === 'education'
);
      ...
      <section className="page-header-v3 py-12">
        <div className="container mx-auto px-4 relative z-10">
          ...
          <p className="text-gray-200 max-w-2xl">
            Scholarship programs, educational grants, and student assistance from the city government.
          </p>
        </div>
      </section>
