...
export const metadata: Metadata = {
  ...
  description: 'Business permits, licensing, and trade services in Zamboanga City.',
};

const services = (servicesData.services as Service[]).filter(
  (s) => s.categoryId === 'business'
);
      ...
      <section className="page-header-v3 py-12">
        <div className="container mx-auto px-4 relative z-10">
          ...
          <p className="text-gray-200 max-w-2xl">
            Business permits, licensing, and commercial services from the City Government.
          </p>
        </div>
      </section>
