...
export const metadata: Metadata = {
  ...
  description: 'Birth, marriage, death certificates and other vital records in Zamboanga City.',
};

const services = (servicesData.services as Service[]).filter(
  (s) => s.categoryId === 'certificates'
);
      ...
      <section className="page-header-v3 py-12">
        <div className="container mx-auto px-4 relative z-10">
          ...
          <p className="text-gray-200 max-w-2xl">
            Birth, marriage, death certificates and other civil registry services from the Local Civil Registrar.
          </p>
        </div>
      </section>
