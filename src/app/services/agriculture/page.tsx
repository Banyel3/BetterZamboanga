...
export const metadata: Metadata = {
  ...
  description: 'Agricultural services and economic development programs in Zamboanga City.',
};

const services = (servicesData.services as Service[]).filter(
  (s) => s.categoryId === 'agriculture'
);
      ...
      <section className="page-header-v3 py-12">
        <div className="container mx-auto px-4 relative z-10">
          ...
          <p className="text-gray-200 max-w-2xl">
            Agricultural support, farm loans, crop insurance, and economic development programs.
          </p>
        </div>
      </section>
