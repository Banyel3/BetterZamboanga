...
export const metadata: Metadata = {
  ...
  description: 'Tax payments, property tax, and fee collection services in Zamboanga City.',
};

const services = (servicesData.services as Service[]).filter(
  (s) => s.categoryId === 'tax-payments'
);
      ...
      <section className="page-header-v3 py-12">
        <div className="container mx-auto px-4 relative z-10">
          <nav className="text-sm text-gray-300 mb-4">
            ...
            <span className="mx-2">/</span>
            <span className="text-white">Tax Payments</span>
          </nav>
          ...
          <p className="text-gray-200 max-w-2xl">
            Property tax, business tax, and other city government fee payments.
          </p>
        </div>
      </section>
