...
export const metadata: Metadata = {
  ...
  description: 'Health programs, medical assistance, and wellness services in Zamboanga City.',
};

const services = (servicesData.services as Service[]).filter(
  (s) => s.categoryId === 'health'
);
      ...
      <section className="page-header-v3 py-12">
        <div className="container mx-auto px-4 relative z-10">
          ...
          <span className="inline-block px-3 py-1 bg-bz-accent-yellow text-bz-primary-dark text-sm font-semibold rounded-full mb-4">
            <i className="bi bi-heart-pulse mr-1"></i>
            Health
          </span>
          ...
          <p className="text-gray-200 max-w-2xl">
            Health programs, medical assistance, and wellness services from the City Health Office.
          </p>
        </div>
      </section>
