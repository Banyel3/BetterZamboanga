...
export const metadata: Metadata = {
  ...
  description: 'Building permits, road maintenance, and infrastructure services in Zamboanga City.',
};

const services = (servicesData.services as Service[]).filter(
  (s) => s.categoryId === 'infrastructure'
);
      ...
      <section className="page-header-v3 py-12">
        <div className="container mx-auto px-4 relative z-10">
          ...
          <p className="text-gray-200 max-w-2xl">
            Building permits, construction, road maintenance, and public works services.
          </p>
        </div>
      </section>
