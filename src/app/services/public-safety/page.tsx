...
export const metadata: Metadata = {
  ...
  description: 'Emergency response, disaster preparedness, and public safety services in Zamboanga City.',
};

const services = (servicesData.services as Service[]).filter(
  (s) => s.categoryId === 'public-safety'
);
      ...
      <section className="page-header-v3 py-12">
        <div className="container mx-auto px-4 relative z-10">
          <nav className="text-sm text-gray-300 mb-4">
            ...
            <span className="mx-2">/</span>
            <span className="text-white">Public Safety</span>
          </nav>
          ...
          <p className="text-gray-200 max-w-2xl">
            Emergency response, disaster preparedness, and public safety services from ZCDRRMO.
          </p>
        </div>
      </section>
