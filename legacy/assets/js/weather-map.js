/**
 * Weather & Map Section for Better Zamboanga Homepage
 * Displays real-time weather data and interactive map of Zamboanga City
...
(function () {
  ...
  function getMockWeather() {
    ...
    for (let i = 0; i < 6; i++) {
      ...
      hourlyForecast.push({
        ...
        temperature: temp,
        icon:
          hour >= 6 && hour < 18 ? "bi-cloud-sun-fill" : "bi-moon-stars-fill",
      });
    }
  ...
  const WeatherService = {
    CACHE_KEY: "zamboanga_weather_cache", // TODO-ZAMBOANGA: Update cache key
    CACHE_TTL: 30 * 60 * 1000,
    API_URL: "https://api.open-meteo.com/v1/forecast",
    COORDINATES: { lat: 6.9214, lon: 122.079 }, // TODO-ZAMBOANGA: Zamboanga City coordinates
    ...
    async fetchWeather() {
        ...
        if (cached) {
          console.log(
            "Weather: Using cached data (expires in " +
              Math.round(
                (cached.timestamp + this.CACHE_TTL - Date.now()) / 1000
              ) +
              "s)"
          );
          return cached;
      ...
      try {
        ...
        console.warn(
          "Weather: ✗ API fetch failed, using mock data -",
          error.message
        );
        return getMockWeather();
      }
  ...
  const WeatherUI = {
    render(container, data) {
      ...
      try {
        ...
        container.innerHTML = `
                <div class="weather-widget" role="region" aria-label="Current weather in Zamboanga City">
                    <div class="weather-current">
                        ...
                        <div class="weather-current-info">
                            ...
                            <div class="weather-current-location">
                                <i class="bi bi-geo-alt" aria-hidden="true"></i> Zamboanga City
                            </div>
                        </div>
                    </div>
  ...
  // ============================================================================
  const MapComponent = {
    ZAMBOANGA_CENTER: [6.9214, 122.079], // TODO-ZAMBOANGA: Zamboanga City Hall coordinates
    DEFAULT_ZOOM: 14,
    map: null,
    ...
    renderTextFallback(container) {
      ...
      // TODO-ZAMBOANGA: Verify bbox calculation for Zamboanga City area
      container.innerHTML = `
            <iframe 
                width="100%" 
                height="300" 
                ...
                marginheight="0" 
                marginwidth="0" 
                src="https://www.openstreetmap.org/export/embed.html?bbox=122.0590%2C6.9014%2C122.0990%2C6.9414&layer=mapnik&marker=6.9214%2C122.0790"
                style="border:0;display:block;"
                title="Map of Zamboanga City"
                loading="lazy">
            </iframe>
        `;
    ...
    initLeaflet(container) {
      try {
        ...
        // Add marker
        // TODO-ZAMBOANGA: Update marker popup with City Hall address
        const marker = L.marker(this.ZAMBOANGA_CENTER).addTo(this.map);
        marker.bindPopup(
          "<strong>Zamboanga City Hall</strong><br>Zamboanga City 7000"
        );
  ...
  (function () {
    ...
    if (document.readyState === "loading") {
      ...
      console.log(
        "=== weather-map.js: DOM already loaded, initializing immediately ==="
      );
      init();
    }
  })();
